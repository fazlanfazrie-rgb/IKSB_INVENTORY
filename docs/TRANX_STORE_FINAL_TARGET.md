...
Required release gates: Flutter analyze, Flutter test, Android release APK, Windows release build, Receive/Issue validation, insufficient-stock protection, and shared Inventory/Bin Card ledger.
