        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: _future == null
                    ? const Center(child: Text('Enter an item code and load the ledger.'))
                        ...
                        builder: (context, s) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return Card(
                                child: ListTile(
                                  title: Text('${r['date']} • ${r['tranx']}'),
                                  subtitle: Text('DOC ${r['doc_no'] ?? ''}  Charging ${r['charging'] ?? ''}'),
                                  trailing: Text(
                                    'IN ${r['receive']}\nOUT ${r['issue']}',
...
class FuelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const StoreModulePage(
        ...
        child: _ModuleInfo(title: 'Fuel Control', text: 'Fuel transactions are stored locally and will use the native FuelEngine.'),
      );
}
...
class FertilizerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const StoreModulePage(
        title: 'Fertilizer',
        icon: Icons.eco,
        child: _ModuleInfo(title: 'Fertilizer Control', text: 'Fertilizer master, receiving and usage workflows are prepared for native integration.'),
      );
}
...
class ReportsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const StoreModulePage(
        ...
        child: _ModuleInfo(title: 'Reports', text: 'Operational reports will read directly from the SQLite ledger.'),
      );
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Icon(Icons.eco, size: 42),
                  const SizedBox(height: 8),
                  Text('TranX_Store • Plantation Operations', style: Theme.of(context).textTheme.bodySmall),
                ],
              ),
            ),
          ),
