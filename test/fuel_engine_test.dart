...
void main() {
  ...
  test('Gold Aug-26 45-SSA4701A daily issue and status', () {
    final rows = <Map<String, Object?>>[
      {'DATE': '2026-08-01', 'ITEM CODE': '010001', 'TRANX': 'OUT', 'CHARGING': '45-SSA4701A', 'ISSUE': 50.0},
      {'DATE': '2026-08-03', 'ITEM CODE': '010001', 'TRANX': 'OUT', 'CHARGING': '45-SSA4701A', 'ISSUE': 60.0},
      {'DATE': '2026-08-05', 'ITEM CODE': '010001', 'TRANX': 'OUT', 'CHARGING': '45-SSA4701A', 'ISSUE': 70.0},
    ];
    expect(FuelEngine.issue(rows: rows, period: DateTime(2026, 8), day: 1, charging: '45-SSA4701A'), 50.0);

    final result = FuelEngine.calculate(
      charging: '45-SSA4701A',
      daily: {1: 50, 3: 60, 5: 70, 8: 50, 10: 60, 11: 70, 12: 30, 16: 20, 24: 70, 25: 30, 26: 50},
    );
